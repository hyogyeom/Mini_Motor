...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets i_enable_IBUF]

## Switches

set_property -dict { PACKAGE_PIN V17  IOSTANDARD LVCMOS33 } [get_ports { i_enable[0]  }]; #IO_L19N_T3_A09_D25_VREF_14 ,Sch=SW0
set_property -dict { PACKAGE_PIN V16  IOSTANDARD LVCMOS33 } [get_ports { i_enable[1]  }]; #IO_L19P_T3_A10_D26_14      ,Sch=SW1
set_property -dict { PACKAGE_PIN W16  IOSTANDARD LVCMOS33 } [get_ports { i_enable[2]  }]; #IO_L20P_T3_A08_D24_14      ,Sch=SW2
...
set_property -dict { PACKAGE_PIN R3   IOSTANDARD LVCMOS33 } [get_ports { i_set_SW }]; #IO_L2P_T0_34               ,Sch=SW11
set_property -dict { PACKAGE_PIN W2   IOSTANDARD LVCMOS33 } [get_ports { i_dir_mode }]; #IO_L5N_T0_34               ,Sch=SW12
set_property -dict { PACKAGE_PIN U1   IOSTANDARD LVCMOS33 } [get_ports { i_ms1 }]; #IO_L3N_T0_DQS_34           ,Sch=SW13
...
set_property -dict { PACKAGE_PIN J1  IOSTANDARD LVCMOS33 } [get_ports { o_motor_0[0] }]; #IO_L3N_T0_DQS_AD5N_35 ,Sch=JA1
set_property -dict { PACKAGE_PIN L2  IOSTANDARD LVCMOS33 } [get_ports { o_motor_0[1] }]; #IO_L5N_T0_AD13N_35    ,Sch=JA2
set_property -dict { PACKAGE_PIN J2  IOSTANDARD LVCMOS33 } [get_ports { o_motor_0[2] }]; #IO_L2N_T0_AD12N_35    ,Sch=JA3
set_property -dict { PACKAGE_PIN G2  IOSTANDARD LVCMOS33 } [get_ports { o_motor_0[3] }]; #IO_L1N_T0_AD4N_35     ,Sch=JA4
...
set_property -dict { PACKAGE_PIN A14  IOSTANDARD LVCMOS33 } [get_ports { o_motor_1[0] }]; #IO_L6P_T0_16       ,Sch=JB1
set_property -dict { PACKAGE_PIN A16  IOSTANDARD LVCMOS33 } [get_ports { o_motor_1[1] }]; #IO_L12P_T1_MRCC_16 ,Sch=JB2
set_property -dict { PACKAGE_PIN B15  IOSTANDARD LVCMOS33 } [get_ports { o_motor_1[2] }]; #IO_L11N_T1_SRCC_16 ,Sch=JB3
set_property -dict { PACKAGE_PIN B16  IOSTANDARD LVCMOS33 } [get_ports { o_motor_1[3] }]; #IO_L13N_T2_MRCC_16 ,Sch=JB4
...
set_property -dict { PACKAGE_PIN K17  IOSTANDARD LVCMOS33 } [get_ports { o_motor_2[0] }]; #IO_L12N_T1_MRCC_14 ,Sch=JC1
set_property -dict { PACKAGE_PIN M18  IOSTANDARD LVCMOS33 } [get_ports { o_motor_2[1] }]; #IO_L11P_T1_SRCC_14 ,Sch=JC2
set_property -dict { PACKAGE_PIN N17  IOSTANDARD LVCMOS33 } [get_ports { o_motor_2[2] }]; #IO_L13P_T2_MRCC_14 ,Sch=JC3
set_property -dict { PACKAGE_PIN P18  IOSTANDARD LVCMOS33 } [get_ports { o_motor_2[3] }]; #IO_L14P_T2_SRCC_14 ,Sch=JC4
